...
역할은 자동 굵게가 사용할 글자 스타일을 찾기 위한 이름표입니다.

![스타일 역할 입력](assets/screenshots/스타일역할입력.png)

글자 스타일 이름은 문서마다 다를 수 있습니다. 그래서 앱은 이름만 보지 않고 역할도 봅니다. 기본 역할은 다음 두 가지입니다.
...
### 13.5 표 안 식별자를 `표점`에서 `-`로 바꾸고 싶습니다
...
### 13.10 마크다운 표 변환 뒤 모양을 바꾸고 싶습니다
